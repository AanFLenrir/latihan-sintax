...
import (
	...
	"latihan-sintaks/app/model" // PASTIKAN INI SAMA DENGAN NAMA DI FILE go.mod
)
...
// Disesuaikan untuk pencarian/urutan tabel students
var allowedSort = map[string]bool{
	"id": true, "name": true, "nim": true, "created_at": true,
}
